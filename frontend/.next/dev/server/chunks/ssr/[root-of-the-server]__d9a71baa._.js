...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        setError('');
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/login', {
                email,
                password
            });
            if (res.data.token) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d9a71baa._.js.map